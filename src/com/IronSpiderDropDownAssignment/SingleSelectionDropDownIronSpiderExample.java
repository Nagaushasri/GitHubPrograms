...
public class SingleSelectionDropDownIronSpiderExample {
	...
	WebElement CoffeeName= driver.findElement(By.name("coffee"));
...
//	 Thread.sleep(500);
//	
	CoffeeNames.selectByValue("cream"); 
//	
//	CoffeeNames.selectByVisibleText("With cream & sugar");
//	
//	//DropName.deselectAll(Black);
//	//DropName.deselectByValue("3");
//	
